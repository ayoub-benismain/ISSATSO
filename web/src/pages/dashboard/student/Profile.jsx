...
export default function ProfileStudent() {
  ...
  const activityData = {
    ...
    month: [
      ...
      { name: "Week 2", usage: 15 },
      { name: "Week 3", usage: 18 },
      { name: "Week 4", usage: 9 },
    ],
  };
  ...
  const bannerButtonClass =
    "bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg font-semibold hover:opacity-90 transition";
  ...
  return (
    <div className="p-6 space-y-8 relative">
      ...
      {/* Banner */}
      <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 rounded-xl w-full shadow-md relative flex flex-col items-center py-6">
        ...
        {/* Stats */}
        <div className="flex gap-8 mt-4 text-white font-semibold">
          ...
          <div className="flex flex-col items-center">
            <ClipboardCheck size={22} className="mb-1" />
            {countUpTrigger && <CountUp end={profile.assignments} duration={1.5} className="text-xl" />}
            <span className="text-sm">Assignments</span>
          </div>
          <div className="flex flex-col items-center">
            <Award size={22} className="mb-1" />
            {countUpTrigger && <CountUp end={profile.achievements} duration={1.5} className="text-xl" />}
